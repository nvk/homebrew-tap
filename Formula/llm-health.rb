class LlmHealth < Formula
  ...
  url "https://github.com/nvk/llm-health/releases/download/v0.0.8/llm_health-0.0.8.tar.gz"
  sha256 "11735d8a904413428261096668257981da36716436e678bdb1bdc90084442d2a"
  license "MIT"
